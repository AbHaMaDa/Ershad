      ...
      <div className="footer-middle container">
        <div className="wrap row row-cols-1 row-cols-sm-2 row-cols-lg-5">
          ...
          <div className="footer-column footer-menu mb-4 mb-lg-0">
            ...
            <ul className="sub-menu__list list-unstyled">
              <li className="sub-menu__item">
                <a href="./about.html" className="menu-link" target="_blank">
                  من نحن
                </a>
              </li>
              <li className="sub-menu__item">
          ...
          <div className="case footer-column footer-menu mb-4 mb-lg-0">
            ...
            <ul className="sub-menu__list list-unstyled">
              <li className="sub-menu__item">
                <a href="./shop2.html" className="menu-link" target="_blank">
                  مسار Front-end developer
                </a>
              </li>
              <li className="sub-menu__item">
                <a href="./shop3.html" className="menu-link" target="_blank">
                  مسار Back-end developer
                </a>
              </li>
              <li className="sub-menu__item">
                <a href="./shop4.html" className="menu-link" target="_blank">
                  مسار Mobile App developer
                </a>
              </li>
              <li className="sub-menu__item">
                <a href="./shop5.html" className="menu-link" target="_blank">
                  مسار Data Analysis
                </a>
              </li>
            </ul>
