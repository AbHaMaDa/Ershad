...
useEffect(() => {
  ...
  return(
    <>
    <nav class={` nav navbar navbar-expand-lg ${isFixed ? 'fixed-top' : ''}`}>
      <div class="container-fluid">
        ...
        <ul className="list  navbar-nav  mb-2 mb-lg-0">
          ...
          <li><a className="dropdown-item" href="#">مسار Front-end developer</a></li>
            <hr className="dropdown-divider" />
            <li><a className="dropdown-item" href="#">مسار back-end developer</a></li>
            <hr className="dropdown-divider" />
            <li><a className="dropdown-item" href="#">مسار full-stack developer</a></li>
            <hr className="dropdown-divider" />
            <li><a className="dropdown-item" href="#">مسار mobile app developer</a></li>
            <hr className="dropdown-divider" />
            <li><a className="dropdown-item" href="#">مسار data-analysis</a></li>
            </ul>
          </li>
